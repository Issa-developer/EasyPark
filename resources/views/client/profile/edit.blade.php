...
<div class="flex flex-col gap-6">
    ...
    {{-- Page Title --}}
    <h1 class="text-2xl font-bold text-[#0d131c] dark:text-slate-100">My Profile</h1>
    ...
    {{-- Edit Form --}}
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
        <h2 class="text-base font-bold text-[#0d131c] dark:text-slate-100 mb-5">Edit Information</h2>
        ...
        <form method="POST" action="{{ route('client.profile.update') }}">
            ...
            <div class="mb-4">
                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">New Password <span class="text-slate-400 font-normal">(leave blank to keep current)</span></label>
    ...
    {{-- Settings Card --}}
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
        <h2 class="text-base font-bold text-[#0d131c] dark:text-slate-100 mb-5">Settings</h2>
